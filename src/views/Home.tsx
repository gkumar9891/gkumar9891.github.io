        ...
        <>
            <section className="banner">
                ...
                <div className="content">
                    <h2>Gaurav Kumar</h2>
                    <p>👋 Hi there! I'm Gaurav, a dedicated software developer with a love for crafting engaging and user-centric web experiences. With expertise in React.js, Vue.js, JavaScript, Java, Spring Boot, HTML, and CSS, I bring over 5 years of hands-on experience in building responsive and dynamic web applications. </p>
